...
def def_full_file_reader():
    ...
    while i <= (len(list_foods) - 1):
        if "$" in list_foods[i]:
            list_foods[i] = (
                str(list_foods[i][: list_foods[i].index("$") - 1])
                + " " * (20 - (list_foods[i].index("$") - 1))
                + str(list_foods[i][list_foods[i].index("$") :])
            )
        i += 1
    ...
    while i <= (len(list_drinks) - 1):
        if "$" in list_drinks[i]:
            list_drinks[i] = (
                str(list_drinks[i][: list_drinks[i].index("$") - 1])
                + " " * (20 - (list_drinks[i].index("$") - 1))
                + str(list_drinks[i][list_drinks[i].index("$") :])
            )
        i += 1
    ...
    while i <= (len(list_services) - 1):
        if "$" in list_services[i]:
            list_services[i] = (
                str(list_services[i][: list_services[i].index("$") - 1])
                + " " * (20 - (list_services[i].index("$") - 1))
                + str(list_services[i][list_services[i].index("$") :])
            )
        i += 1
